  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-zinc-950">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 safe-area-inset">
        ...
        {/* Main Choices */}
        <div className="w-full max-w-2xl grid md:grid-cols-2 gap-4 md:gap-6 mobile-slide-up">
          {/* Shop */}
          <Link
            href="/shop"
            className="group relative bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 rounded-xl md:rounded-2xl p-4 md:p-8 hover:border-white/50 transition-all duration-300 hover:bg-zinc-900 mobile-touch-target mobile-card"
          >
            <div className="flex flex-col items-center text-center space-y-2 md:space-y-4">
              <div className="flex items-center gap-3 px-4 md:px-6 py-2 md:py-3 bg-white/10 rounded-full text-lg md:text-xl font-bold text-white group-hover:bg-white/20 group-hover:text-white transition-colors mobile-touch-target">
                <ShoppingBag size={20} className="text-white md:w-6 md:h-6" />
                <span>Shop →</span>
              </div>
              <p className="text-zinc-400 group-hover:text-zinc-300 transition-colors text-sm md:text-base leading-tight md:leading-normal mobile-line-clamp-2">
        ...
        <div className="mt-8 text-center mobile-fade-in">
          <p className="text-zinc-400 text-sm mb-3 mobile-px-3">Are you a Romanian designer?</p>
          <Link 
            href="/designer-auth"
